...
myDict= {"name":"Giorgio", "surname":"Bianchi", "birth_date":1992 }
print("this is a dictionary , myDict =", myDict)
print("you can also take just one item of the dictionary using print(myDict['name']), like this ",myDict["name"])
print("by using myDict.keys() you can check all the keys in your dictionary , like this",myDict.keys())
print("by using myDict.values() you can check all the values in your dictionary , like this",myDict.values())
print("by using myDict.items() you can check all the items in your dictionary as tuples in a list , like this",myDict.items())
